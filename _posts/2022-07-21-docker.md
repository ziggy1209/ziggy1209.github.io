...
You can check all the containers on your device by typing
```bash
docker ps
```
...
```
To start one of the containers, you can type
```bash
docker start <the id/name of your container>
```
Then, you can check all the **running** containers by typing
```bash
docker ps -a
```
...
Having these two installed, you can first follow the steps in https://code.visualstudio.com/docs/remote/ssh to connect to the remote host and then refer to https://code.visualstudio.com/remote/advancedcontainers/develop-remote-host to open a folder in the container.
