...
Having finished the installation, you can check if it's functioning right by typing commands:
```bash
sudo docker run hello-world
```
and the response showing that you have installed it successfully would be:
```bash
```
